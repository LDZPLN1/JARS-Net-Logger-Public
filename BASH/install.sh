...
FILES+=("./html/jars_export_net_logs_adi.php")
FILES+=("./html/jars_export_net_logs_csv.php")
FILES+=("./html/jars_export_net_logs_sql.php")
FILES+=("./html/jars_export_visitor_list_csv.php")
FILES+=("./html/jars_export_visitor_list_sql.php")
